...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'This very portfolio website built with React, Tailwind CSS, and Framer Motion for smooth animations.',
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <motion.div key={project.title} variants={itemVariants}>
                <Card className={`h-full ${project.featured ? 'border-primary shadow-lg' : ''}`}>
